  ...
  return (
    ...
    <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-white text-purple-500 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
        </div>
      ...
      <div className="bg-gray-100 py-20 px-4">
        ...
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="mt-4 font-bold">- Sridhar</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <FaQuoteLeft className="text-xl text-gray-400" />
            <p className="mt-4">
            ...
            <p className="mt-4 font-bold">- Sanjay</p>
          </div>
        </div>
      </div>
      {/* CTA */}
